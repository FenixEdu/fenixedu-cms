...
<p class="small"><spring:message code="post.create.label.site" />: <a href="${pageContext.request.contextPath}/cms/manage/blog/posts"></a><strong>${site.name.content}</strong></a>  </p>
