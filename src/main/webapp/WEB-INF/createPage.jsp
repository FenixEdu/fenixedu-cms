...
<p class="small"><spring:message code="menu.create.label.site" />: <strong><a href="${pageContext.request.contextPath}/cms/sites/${site.slug}">${site.name.content}</a></strong>  </p>
