        ...
        <table class="table table-striped">
            ...
            <c:forEach var="i" items="${sites}">
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="${pageContext.request.contextPath}/cms/sites/${i.slug}"
                               class="btn btn-sm btn-default"><spring:message code="action.manage"/></a>
                        </div>
                    </td>
                </tr>
            </c:forEach>
                ...
                <div class="col-md-2 col-md-offset-5">
                    <ul class="pagination">
                        <li class="${currentPage <= 0 ? 'disabled' : 'active'}"><a
                                href="${pageContext.request.contextPath}/cms/sites/manage/${page - 1}">«</a></li>
