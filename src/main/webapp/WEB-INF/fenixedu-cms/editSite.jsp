            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                            <div class="col-sm-6">
                            <select id="ga-accounts" class="form-control">
                                
                            </select>
                            </div>
                            <div class="col-sm-6">
                            <select disabled="disabled" id="ga-properties" class="form-control">
                                
                            </select>
                            </div>
                            </div>
                            <p class="help-block">If you need to create a new property for this site, go to <a href="https://www.google.com/analytics">Google Analytics</a> create it there and then selected it here.</p>
                        </div>
                        
                </div>

<!--                 <div class="form-group new-property">
                        <label for="inputEmail3" class="col-sm-2 control-label">Name</label>

                        <div class="col-sm-10">
                            <input type="text" id="googleAPIName" class="form-control" required="required" value="${site.name.content}">
                        </div>
                ...
                <div class="form-group new-property">
                        ...
                        <div class="col-sm-10">
                            <input disabled type="text" id="googleAPIUrl" class="form-control" required="required" value="${url}">
                        </div>
                </div> -->
            </div>
