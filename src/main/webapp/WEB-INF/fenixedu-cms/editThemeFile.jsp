...
<div class="btn-toolbar" style="background:white" role="toolbar">
  ...
  <div class="btn-group">
    <a href="<c:url value="${ linkBack }" />" type="button" class="btn btn-default"><span class="glyphicon glyphicon-chevron-left"></span> <spring:message code="action.back" /></a>
  </div>
...
&nbsp;
    <div class="btn-group">
    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="modes-msg"><spring:message code="file.edit.label.highlight" /></span> <span class="caret"></span></button>
